...
const abi = JSON.parse(readFileSync(join(__dirname, "out/contracts_QFCCards_sol_QFCCards.abi"), "utf8"));
const bin = readFileSync(join(__dirname, "out/contracts_QFCCards_sol_QFCCards.bin"), "utf8");

console.log(`Deploying QFCCards from ${wallet.address}...`);
...
console.log(`✅ QFCCards deployed at: ${addr}`);
